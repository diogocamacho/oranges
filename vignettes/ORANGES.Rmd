---
title: "ORANGES: Over Representation ANalyses for Gene Expression Signatures"
author: "Diogo M. Camacho"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ORANGES}
...
query <- lung_res %>% 
  ...
  tibble::add_column(., symbol = genes_lung$SYMBOL, .before = 2) %>%
...
```{r volcano, fig.height=7, fig.width=7, fig.align="center"}
lung_res %>% 
  ggplot() +
  geom_point(aes(x = logFC, y = -log10(adj.P.Val)), alpha = 0.5, size = 3) +
...
```{r plotting, fig.height=7, fig.width=7, fig.align="center"}
plot_oranges(res)
```
